...
charts.Axis = function (options = {}) {
  ...
  this.tickYInterval = options.tickYInterval || 150;
...
charts.Axis.prototype.init = function () {
  ...
  for (let i = 1; i < this.axisYSize / this.tickYInterval; i++) {
    ...
    const text = new Konva.Text({
      ...
      y: this.tickYInterval * i - this.fontSize / 2,
      text: str,
      fontSize: this.fontSize,
      fontFamily: 'Calibri',
      fill: this.axisColor,
  ...
  this.group.add(this.axisX, this.axisY, this.tickX, this.axisXText, this.axisYText);
};